...
**Current release: v5.27.1 (2026-04-28).** Pre-6.0 testing window. v5.27.0 minor closes the full mempalace alignment with configuration parity across REST + MCP + CLI + comm channels + PWA; v5.27.1 patch fixes a PWA xterm refit + input rebind bug on prompt cycle. Practical how-tos live in [`docs/howto/`](docs/howto/README.md). Per-version detail in [CHANGELOG.md](CHANGELOG.md); cumulative release notes since v4.0.0 in [docs/plans/RELEASE-NOTES-v5.0.0.md](docs/plans/RELEASE-NOTES-v5.0.0.md).
