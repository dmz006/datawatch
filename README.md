...
**[v8.14.0](CHANGELOG.md) (2026-08-29)** — feat(goose): BL363 complete — Goose/goose-prompt backend with provider/model/API-key injection, MCP channel bridge, agent container, 22 unit tests, full Settings UI and docs coverage.
