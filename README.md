...
**Current release: v6.0.3 (2026-05-02).** Patch: PWA layout restructure (BL238) — Plugins, Routing, and Orchestrator moved from bottom nav to dedicated Settings sub-tabs. Nav bar is now clean and minimal. See [CHANGELOG.md](CHANGELOG.md) for full history; [RELEASE-NOTES-v6.0.0.md](docs/plans/RELEASE-NOTES-v6.0.0.md) for the comprehensive v5→v6 notes.
