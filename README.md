...
**Current release: v6.5.6 (2026-05-04).** Patch: BL252 Phases 3+4 — PWA i18n for Automata/PRD management (lifecycle strip, all modals) and Stats/Alerts panels (70 new locale keys). See [CHANGELOG.md](CHANGELOG.md) for full history.
