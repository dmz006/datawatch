...
**Current release: v6.6.0 (2026-05-04).** Minor: BL252 PWA i18n full coverage (closes GH#32) — 7 phases shipping ~190 new locale keys across all 5 bundles, plus BL246 partial UX fixes (FAB, stale help, offscreen menu, workspace label, Skills) and BL247/BL249/BL250 closed. See [CHANGELOG.md](CHANGELOG.md) for full history.
