...
**Current release: v6.5.3 (2026-05-04).** Patch: BL243 Phase 3 — ACL policy generator + push with existing-node awareness; 7-surface parity. See [CHANGELOG.md](CHANGELOG.md) for full history.
