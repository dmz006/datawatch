...
[![Release](https://img.shields.io/badge/release-v8.13.25-success)](https://github.com/dmz006/datawatch/releases/tag/v8.13.25)
...
**[v8.13.25](CHANGELOG.md) (2026-08-08)** — fix(ci): ZAP rule 10024 IGNORE — `session_id` URL param is a resource filter not an auth token; closed 15 stale ZAP issues (GH#130–144). 2394 tests.
