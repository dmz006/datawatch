...
**Current release: v6.0.0 (2026-05-02).** Major release closing the v5.28.x patch window. Highlights: BL220 configuration accessibility parity — every feature area now reachable from all 6 surfaces (YAML + REST + MCP + CLI + Comm + PWA), including 9 new Comm channel commands, 3 dedicated MCP tools, 2 CLI subcommands, 11 new PWA settings panels and 4 full-page management views. LLM model alias list refreshed (Opus 4.7 / Sonnet 4.6 / Haiku 4.5). Comprehensive notes: [RELEASE-NOTES-v6.0.0.md](docs/plans/RELEASE-NOTES-v6.0.0.md). Per-version detail in [CHANGELOG.md](CHANGELOG.md).
