...
**Current release: v6.0.8 (2026-05-02).** Patch: BL219 LLM tooling artifact lifecycle — per-backend gitignore hygiene + cleanup on session end; REST/MCP/CLI/comm/PWA parity. See [CHANGELOG.md](CHANGELOG.md) for full history; [RELEASE-NOTES-v6.0.0.md](docs/plans/RELEASE-NOTES-v6.0.0.md) for the comprehensive v5→v6 notes.
