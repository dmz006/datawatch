...
**Current release: v6.0.6 (2026-05-02).** Patch: BL228 security scanners in language Dockerfiles (govulncheck/bandit+pip-audit/eslint-plugin-security/cargo-audit/brakeman+bundler-audit). See [CHANGELOG.md](CHANGELOG.md) for full history; [RELEASE-NOTES-v6.0.0.md](docs/plans/RELEASE-NOTES-v6.0.0.md) for the comprehensive v5→v6 notes.
