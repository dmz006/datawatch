...
[![Release](https://img.shields.io/badge/release-v8.13.30-success)](https://github.com/dmz006/datawatch/releases/tag/v8.13.30)
...
**[v8.13.30](CHANGELOG.md) (2026-08-12)** — fix(docker): rtk curl download in Dockerfile.agent-base now retries on 503 (--retry 5). 2394 tests.
