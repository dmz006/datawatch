...
**Current release: v6.5.7 (2026-05-04).** Patch: BL252 Phase 5 — PWA i18n for Settings panel (auth, servers, Signal, About — 24 new locale keys). See [CHANGELOG.md](CHANGELOG.md) for full history.
