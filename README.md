...
**Current release: v5.26.30 (2026-04-27).** Patch series leading up to v6.0 later this week — every release between now and v6.0 is a patch (no fresh binaries/containers; operator pulls fixes via `git pull` or the v6.0 cut). Practical how-tos live in [`docs/howto/`](docs/howto/README.md). Per-version detail in [CHANGELOG.md](CHANGELOG.md); cumulative release notes since v4.0.0 in [docs/plans/RELEASE-NOTES-v5.0.0.md](docs/plans/RELEASE-NOTES-v5.0.0.md).
