...
_story_ts_667() {
  ...
  cfg_resp=$(api_code PUT /api/config '{"vision.enabled":true,"vision.backend":"ollama","vision.endpoint":"http://localhost:11434","vision.model":"llmvision/glimpse-v1:latest"}')
