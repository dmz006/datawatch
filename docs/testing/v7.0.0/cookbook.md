...
**Latest Run**: 2026-05-15T12:31:12Z (Run 014 — Full E2E Suite + TS-241 + TS-244 Fixes)
**Pass Rate**: 76% (143/187 tests)
...
| T17 | End-to-End Journeys | 10 | 10 | 0 | 0 | ✅ (TS-241 + TS-244 fixed) |
| — | **TOTAL** | **187** | **143** | **2** | **42** | **76% Pass** |
...
| **TS-244** | Council journey — runs API | 🟢 FIXED ✅ | Fixed: endpoint corrected to /api/council/run + parameters (proposal/personas/mode) aligned |
