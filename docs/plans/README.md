...
Latest release: **v8.20.2** (2026-09-06). fix: autonomous sessions wait for task completion before verifying + are cleaned up after; New Automaton modal shows all execution backends.
