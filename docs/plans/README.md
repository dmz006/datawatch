...
Latest release: **v8.20.1** (2026-09-06). fix: cancelled PRD restart — Reset to Draft button + Settings access for cancelled PRDs; `POST /api/autonomous/prds/{id}/reset_to_draft` + MCP tool.
