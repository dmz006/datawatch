...
Latest release: **v5.28.0** (2026-04-30, BL214 — PWA i18n foundation with DE/ES/FR/JA translations sourced from datawatch-app Compose Multiplatform Android client).
...
| Active backlog | 2 | BL190 cosmetic (iterative) · BL173-followup (operator-side, no code action). BL214 foundation closed in v5.28.0; iterative string-coverage expansion continues in v5.28.x. |
