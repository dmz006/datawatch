...
Latest release: **v5.27.8** (2026-04-30, BL208 #30 + BL210 — PRD card alignment + daemon-MCP gap closures).

| Bucket | Count | Notes |
|---|---|---|
| Open bugs | 0 | BL211 + BL215 closed in v5.27.6. |
| Open features | 2 | datawatch#31 (Signal device-linking, BL213) · #32 (PWA i18n, BL214). #26/#27/#28/#29/#30 closed in v5.27.7-v5.27.8. |
| Active backlog | 4 | **BL213** Signal device-linking API · **BL214** PWA i18n DE/ES/FR/JA · BL190 cosmetic · BL173-followup. BL208 #30 + BL210 closed in v5.27.8. |
