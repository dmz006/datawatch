...
Latest release: **v8.13.23** (2026-07-22). fix(ci): goreleaser retry binary (curl installer + dynamic rate-limit sleep); attach-tarball depends on goreleaser to prevent "release not found" race.
