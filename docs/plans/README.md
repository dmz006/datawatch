...
Latest release: **v8.19.10** (2026-09-06). fix: autonomous task sessions were ignoring the configured PRD LLM backend and silently falling back to claude-code; fixed by resolving named inference-registry backends to their kind string in handleStartSession.
