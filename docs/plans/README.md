...
| Pending backlog | 2 | BL335 — APNs push for iOS client (GH#107); BL367 — autonomous PRD quality gates (BL28 parity); BL369 — prompt injection hardening in autonomous executor |
| Deferred | 0 | — |
