...
Latest release: **v8.20.0** (2026-09-06). feat: autonomous PRD planning backend separated from task-execution backend — `decomposition_profile` wired; execution backend now accepts opencode/goose/claude-code.
