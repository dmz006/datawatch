...
Latest release: **v5.27.7** (2026-04-30, BL208 partial + BL209 + BL212 — PWA UI parity, config-driven quick commands, channel.js memory tools).

| Bucket | Count | Notes |
|---|---|---|
| Open bugs | 0 | BL211 + BL215 closed in v5.27.6. |
| Open features | 3 | datawatch#30 (PRD card alignment, BL208 deferred to v5.27.8) · #31 (Signal device-linking, BL213) · #32 (PWA i18n, BL214). #26/#27/#28/#29 closed in v5.27.7. |
| Active backlog | 5 | **BL208 #30** PRD card style alignment (deferred to v5.27.8 — bigger restyle) · **BL210** daemon-MCP parity audit · **BL213** Signal device-linking API · **BL214** PWA i18n DE/ES/FR/JA · BL190 cosmetic · BL173-followup. BL208 #26+#27, BL209, BL212 all closed in v5.27.7. |
