...
Latest release: **v8.20.5** (2026-09-07). fix(autonomous): decompose/verify/guardrail named-LLM routing — resolveAskBackend was discarding the registry name, routing planning calls through localhost:3000 instead of the configured compute node.
