...
| Bucket | Count | Notes |
|---|---|---|
| Open bugs | 1 | **BL211** scrollback state-detection (operator repro 2026-04-29) — daemon thinks session running while pane shows "Crunched for X" because state detection reads the scrolled view; ships as v5.27.6 hotfix. |
| Open features | 5 | datawatch#26 (PWA Running pulse + generating dots, BL208) · datawatch#27 (`📜` scroll icon, BL208) · datawatch#28 (config-driven quick commands, BL209) · datawatch#29 (channel.js MCP memory tools, BL212) · datawatch#30 (PWA PRD card alignment + header rename, BL208 extended). All filed 2026-04-29/30 post-v5.27.5. |
| Active backlog | 7 | **BL211** scrollback state-detection bug (ship FIRST as v5.27.6 hotfix) · **BL208** UI parity bundle (datawatch#26 + #27 + #30 PRD-card alignment) · **BL209** config-driven quick commands (datawatch#28) · **BL210** daemon-MCP parity audit · **BL212** channel.js bridge MCP memory tools (datawatch#29) · BL190 cosmetic follow-up · BL173-followup. |
