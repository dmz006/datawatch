...
| Bucket | Count | Notes |
|---|---|---|
| Open bugs | 1 | B88 — Automata comm-channel missing `cancel_story`, `cancel_task` (BL382 regression; both on REST+MCP+PWA), `reset_to_draft`, `set_quality_gates`, `scan_results` (present on REST+MCP+PWA) |
