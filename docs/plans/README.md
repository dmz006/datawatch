...
Latest release: **v8.19.9** (2026-09-06). fix(pwa): PRD backend picker filtered to ollama/openwebui only; Approve+Reject buttons restored in needs_review detail view; misleading lifecycle hint corrected.
