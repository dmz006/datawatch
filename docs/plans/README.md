...
Latest release: **v8.20.4** (2026-09-07). fix: Start Planning visual feedback + progress container in detail view; poll() double-JSON bug; Edit menu escape stacking context on desktop.
