...
Latest release: **v5.27.9** (2026-04-30, BL213 — Signal device-linking API completion + BL212 follow-up — JS channel fallback memory tool parity).

| Bucket | Count | Notes |
|---|---|---|
| Open bugs | 0 | BL211 + BL215 closed in v5.27.6. |
| Open features | 1 | datawatch#32 (PWA i18n, BL214). #26/#27/#28/#29/#30/#31 closed in v5.27.7-v5.27.9. |
| Active backlog | 3 | **BL214** PWA i18n DE/ES/FR/JA · BL190 cosmetic · BL173-followup. BL213 closed in v5.27.9. BL208 #30 + BL210 closed in v5.27.8. |
