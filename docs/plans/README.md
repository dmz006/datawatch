...
Latest release: **v5.27.6** (2026-04-30, hotfix — BL211 scrollback state-detection + BL215 rate-limit miss).
...
| Active backlog | 7 | **BL208** UI parity bundle (#26+#27+#30) · **BL209** config-driven quick commands (#28) · **BL210** daemon-MCP parity audit · **BL212** channel.js bridge MCP memory tools (#29) · **BL213** Signal device-linking API (#31) · **BL214** PWA i18n DE/ES/FR/JA (#32) · BL190 cosmetic · BL173-followup. BL211 + BL215 closed v5.27.6. |
