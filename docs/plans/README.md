...
Latest release: **v8.20.3** (2026-09-07). fix: prominent Plan/Run buttons in PRD toolbar; image attachment file picker on mobile PWA; wizard backend fields + dir validation.
