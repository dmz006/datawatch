...
func (s *Server) handleSessionsSubpath(w http.ResponseWriter, r *http.Request) {
	...
	case strings.Contains(rest, "/guardrail/") && strings.HasSuffix(rest, "/approve"):
		// GH#153 — per-guardrail block approval for Android Auto BL33.
		s.handleSessionGuardrailApprove(w, r)
